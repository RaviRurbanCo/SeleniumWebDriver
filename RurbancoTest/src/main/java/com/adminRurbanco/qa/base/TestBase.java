package com.adminRurbanco.qa.base;
...
public class TestBase {
	...
	public TestBase() {//throws IOException{
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream("C:\\NewEclipse\\RurbancoTest\\src\\main\\java\\com\\adminRurbanco\\qa\\config\\config.properties");
			prop.load(ip);
